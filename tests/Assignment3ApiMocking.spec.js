...
test('Sandbox banner is showm when mocking with 6 data',  async({page})=>{
    const eventCards = page.locator("//article[@id='event-card']");
    const banner = page.locator("//span[contains(text(),'Your sandbox holds up to ')]");
...
test('Sandbox banner is not showm when mocking with 4 data',  async({page})=>{
    const eventCards = page.locator("//article[@id='event-card']");
    const banner = page.locator("//span[contains(text(),'Your sandbox holds up to ')]");
    await page.route('https://api.eventhub.rahulshettyacademy.com/api/events*', async(route)=>{
